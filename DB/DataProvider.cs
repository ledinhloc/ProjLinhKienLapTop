...
namespace ProCuaHangLinhKienLaptop.DB
{
    public class DataProvider
    {
        ...
        private string connectionString = "Data Source=localhost;Initial Catalog=LinhkienLaptop; User Id="+ Program.Email + ";Password=" + Program.MatKhau + ";Connect Timeout=30;";
        public DataProvider() {
            try
            {
